...
@RestController
@RequestMapping("financeiro/contas_receber/entities/contaReceber")
public class ContaReceberController {
	...
	@GetMapping("/contaReceberHistConcBancariaAutoComplete")
	public Collection<ContaReceberHistConcBancariaAutoComplete> contaReceberHistConcBancariaAutoComplete(@RequestParam("query") String query) {
	...
	public void actionBaixarContaComDataPagamentoHoje(@PathVariable java.util.UUID id) {
		try {
			contaReceberService.actionBaixarContaComDataPagamentoHoje(id);
		}
	...
	public void actionBaixarContaComDataPagamentoIgualDataVenciento(@PathVariable java.util.UUID id) {
		try {
			contaReceberService.actionBaixarContaComDataPagamentoIgualDataVenciento(id);
		}
		catch(IllegalStateException e) {
			throw new ResponseStatusException(HttpStatus.BAD_REQUEST, e.getMessage(), e);
		}
